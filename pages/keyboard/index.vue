<template>
  <div style="margin-top:100px;width:1800px;margin-left:auto;margin-right:auto;">
    <!-- 轮播图开始 -->
  ...
  data(){
    return {
      ...
      swiperOption:{
         ...
         *  还可以使用PageUp/PageDown键控制（4.5.1后）
         * 
         */
        // keyboard:true, // 类型是Boolean或者object，默认false
        /**
         * keyboard 设置为true，相当于
         * keyboard: {
         *      enabled: true,
         *      onlyInViewport: true,
         *  },
        ...
        keyboard: {
            //开启后可以使用键盘切换
               enabled: true, //类型是Boolean，默认false
               //默认仅控制当前窗口内的swiper切换。当swiper离开可视区域则无法切换。禁止后，即使swiper不在可视区域也能键盘控制切换
               onlyInViewport: true, //类型是Boolean，默认true
            //    是否允许使用键盘的pageUp 和pageDown键来控制Swiper切换。设为false 后无法使用键盘的pageUp 和pageDown键。
            // 默认是true，允许使用。版本必须大于5.4.5
            pageUpDown:true,//类型是Boolean，默认true
           },
        // 事件注册
        on:{
