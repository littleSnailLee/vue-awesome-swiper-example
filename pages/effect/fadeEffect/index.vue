...
<div>
    ...
    <div class="swiper-wrapper">
        <div class="swiper-slide" v-for="banner in banners" :key="banner.id">
            <img :src="banner.imageUrl">  data-swiper-parallax-scale='0.5' data-swiper-parallax-opacity='0.5'>
        </div>
    </div>
...
data(){
    ...
    swiperOption:{
        ...
        speed: 5000, //类型是数字 默认是300，
        grabCursor: true, //鼠标进入到swiper，显示手掌形状，拖动显示抓手
        parallax:true, //设置视觉效果 推出缩放
        //------------------------一般选项 end------------------------
        ...
        autoplay:{
            ...
            waitForTransition: true,//默认为true，等待过渡完毕。自动切换会在slide过渡完毕后才开始计时。设置为false，过渡开始时就开始计时
        },
