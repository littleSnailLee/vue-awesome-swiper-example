    ...
    <div class="swiper-container" v-swiper:MySwiper="swiperOption"  >
      <div class="swiper-wrapper">
        <div class="swiper-slide" v-for="banner in banners" :key="banner.id">
            <img :src="banner.imageUrl" data-swiper-parallax-opacity="0.5" data-swiper-parallax-scale="0.5">
        </div>
      </div>
...
export default {
  data(){
    return {
      ...
      swiperOption:{
        //  -------------------一般选项start--------------------
          initialSlide: 0, // 初始化 显示第2个slide，默认第一张，
          direction: 'horizontal', //slide切换方向 水平
          speed: 900, //类型是数字 默认是300，
          grabCursor: true, //鼠标进入到swiper，显示手掌形状，拖动显示抓手
          roundLengths: true, //slide大约宽度
            //add 
          parallax:true, //开启视差效果，设置进入和出去时的透明度和缩放效果
        ...
        //-----------------网格分布 start----------------------
            ...
            slidesPerView:3,// 类型是数字或者‘auto' ， 默认值是1
             ...
             //centeredSlides 一个页面显示多个slide，设置为true，active 激活的slide会居中显示，而不是默认情况下的左边
            centeredSlides: true, //类型是Boolean 默认值是false

             // centeredSlidesBounds: 当设置了Active Slide居中后，还可以配合设置此参数，使得第一个和最后一个Slide 始终贴合边缘。
            centeredSlidesBounds:true, //类型是Boolean 默认值是false
