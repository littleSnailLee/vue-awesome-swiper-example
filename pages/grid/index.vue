    ...
    return {
      ...
      swiperOption:{
        ...
        slidesPerView:3,// 类型是数字或者‘auto' ， 默认值是1
          ...
          // spaceBetween： 设置slide之间间距，可以是数字（单位px),也可以是百分比(相对于container)
          spaceBetween: 50, // 类型是number ,默认是0

          // slidesOffset 设置前后位移量 详见/slidesOffset

          //centerInsufficientSlides 当slide数小于slidesPerview时，居中显示所有slide 详见 /centerInsufficientSlides
